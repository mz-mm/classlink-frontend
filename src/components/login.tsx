      ...
      <div className="flex items-center justify-center h-screen" style={{touchAction: "none"}}>
        <form onSubmit={handleSubmit}>
          <div className="bg-white py-5 rounded-xl shadow-2xl ">
            ...
            <div>{error !== "" && <h1 className="flex mb-4 text-white rounded bg-red-500 mx-10 py-2 items-center justify-center">{error}</h1>}</div>
            <div className="px-10">
              ...
              />
              <button className="w-full rounded mt-4 text-white bg-blue-500 shadow-lg transition delay-75 shadow-blue-500/50 mb-4 py-2 hover:opacity-80 hover:-translate-y-1">
                Login
              </button>
